...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude", "codex", "cursor", "gemini", "kimi", "minimax", "opencode", "opencodego", "synthetic", "zai"],
            expectedReferenceCount: 20,
            expectedReferenceFingerprint: ["codex@0", "claude@1", "cursor@2", "codex@5", "minimax@8", "cursor@9", "minimax@10", "codex@11", "codex@23", "codex@24", "claude@25", "cursor@26", "opencode@27", "opencodego@28", "zai@29", "synthetic@30", "minimax@31", "kimi@32", "gemini@33", "claude@35"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/AgentSession.swift",
            line: 570,
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 10,
            expectedReferenceFingerprint: ["codex@0", "claude@2", "codex@3", "kimi@4", "moonshot@5", "codex@14", "openai@15", "claude@16", "kimi@18", "moonshot@20"],
            reason: "Provider-specific by design: cross-provider dispatch in shared code."),
        AllowedProviderConstruct(
