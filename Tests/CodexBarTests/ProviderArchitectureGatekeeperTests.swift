...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["claude@0", "claude@1", "claude@5", "claude@15"],
            reason: "Derived cross-provider construct cluster."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+WidgetSnapshot.swift",
            line: 338,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["deepseek"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["deepseek@0", "deepseek@3"],
            reason: "Derived cross-provider construct cluster."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore.swift",
            line: 1104,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["claude@0", "claude@4", "claude@7"],
            reason: "Derived cross-provider construct cluster."),
        AllowedProviderConstruct(
